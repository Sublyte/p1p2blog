...
const CommentsForm = ({ slug }) => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
            <h3 className="text-xl mb-8 font-semibold border-b pb-4">Leave your thoughts.</h3>
            ...
            <div className="mt-8">
                ...
                className="transition duration-500 ease hover:bg-purple-700 inline-block bg-purple-500 text-lg rounded-full text-white px-8 py-3 cursor-pointer"
